...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, ADC_PMID_MEAS_Pin|ADC_3V3_MEAS_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC_VBUS_MEAS_Pin|ADC_VBAT_MEAS_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PA10     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(SYS_SCL_GPIO_Port, SYS_SCL_Pin);

    HAL_GPIO_DeInit(SYS_SDA_GPIO_Port, SYS_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(CTRL_SCL_GPIO_Port, CTRL_SCL_Pin);

    HAL_GPIO_DeInit(CTRL_SDA_GPIO_Port, CTRL_SDA_Pin);
